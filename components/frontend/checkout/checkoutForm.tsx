...
export default function CheckoutForm({
  ...
  if (citys) {
    dUpazilaData = citys.filter(
      (upazilaItem: ICity) => upazilaItem.district_id === dDistrictData?.id
    );
  }
  ...
  async function onSubmit(data: Partial<CheckoutFormValues>) {
    try {
      ...
      const orderData: any = {
        ...
        billingAddress: data.address + ", " + data.city + ", " + data.district,
  ...
  const delivery =
    sortedCartItems?.length === 0 ? 0 : shippingCost ? Number(shippingCost) : 0;
          ...
          >
            <div className="w-full flex flex-col sm:flex-row items-start gap-10 pb-7">
              ...
              <div className="flex flex-col gap-4 w-full sm:w-7/12 flex-1 px-2 sm:px-4">
                ...
                <div className="flex flex-col gap-2">
                          ...
                          <FormItem>
                            ...
                            <FormControl>
                              <Input
                                ...
                                {...field}
                                onBlur={(e) =>
                                  handleChange("firstName", field.value)
                                }
                              />
                            </FormControl>
                          ...
                          <FormItem>
                            ...
                            <FormControl>
                              <Input
                                ...
                                {...field}
                                onBlur={(e) =>
                                  handleChange("lastName", field.value)
                                }
                              />
                            </FormControl>
                            <FormDescription></FormDescription>
                              ...
                              <PopoverTrigger asChild>
                                <FormControl>
                                  <Button
                                    ...
                                    onClick={() =>
                                      setDistrictPopOpen(!districtPopOpen)
                                      ...
                                      {districts?.map((district) => (
                                        <CommandItem
                                          ...
                                          onSelect={() => {
                                            ...
                                            setDistrictPopOpen(false); // Close the popover after selection
                                          }}
                                        >
                                          <Check
                                            className={cn(
                            ...
                            <PopoverTrigger asChild>
                              <FormControl>
                                <Button
                                  ...
                                  onClick={() => setCityPopOpen(!cityPopOpen)}
                                >
                                  {field.value
                                    ? upazilaData.find(
                                        (upazila) =>
                                          upazila.name === field.value
                                      )?.name
                                    : "Select city"}
                                  <ChevronsUpDown className="ml-2 h-4 w-4 shrink-0 opacity-50" />
                                </Button>
                                  ...
                                  <CommandGroup>
                                    {upazilaData?.map((upazila) => (
                                      <CommandItem
                                        ...
                                        key={upazila.id}
                                        onSelect={() => {
                                          form.setValue("city", upazila.name);
                                          setCityPopOpen(false); // Close the popover after selection
                                        }}
                                      >
                                        <Check
                                          className={cn(
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    />
                    <p className="text-sm">Ship to a different address?</p>
                  </div>
                </div>
                                ...
                                <PopoverTrigger asChild>
                                  <FormControl>
                                    <Button
                                      ...
                                      onClick={() =>
                                        setdDistrictPopOpen(!districtPopOpen)
                                      } // Toggle popover on button click
                                    >
                                      {field.value
                                        ? districts.find(
                                        ...
                                        {districts?.map((district) => (
                                          <CommandItem
                                            ...
                                            onSelect={() => {
                                              ...
                                              setdDistrictPopOpen(false); // Close the popover after selection
                                            }}
                                          >
                                            <Check
                                              className={cn(
                                      ...
                                      {dUpazilaData?.map((upazila) => (
                                        <CommandItem
                                          ...
                                          onSelect={() => {
                                            ...
                                            setdCityPopOpen(false); // Close the popover after selection
                                          }}
                                        >
                                          <Check
                                            className={cn(
              ...
              <div className="w-full sm:w-5/12 px-2 sm:px-4">
                <h2 className="text-xl font-semibold pb-6">Your Order</h2>
                  ...
                  <div className="border-b">
                    ...
                    <div className="flex justify-between p-3">
                      ...
                      <span className="text-sm">
                        {discount > 0 && "-"}৳ {discountPrice.toFixed(2)}
                      </span>
                    </div>
                    <div className="flex justify-between p-3">
                      <span className="text-sm">Shipping: (chargeable)</span>
                      <span className="text-sm">
                  ...
                  render={({ field }) => (
                    ...
                    >
                      <div className="mt-3 border w-full rounded flex flex-col gap-2 p-3">
                        ...
                        <div className="p-2">
                          <div className="flex items-center gap-2">
                            <RadioGroupItem value="online" id="sslcommerz" />
                            <Label
                              htmlFor="sslcommerz"
                              className="text-sm font-semibold"
                            >
                          ...
                          <span className="text-xs text-wrap">
                            Pay bank transfer via SSLCOMMERZ. Pay Online
                            (Credit/Debit Card/MobileBanking/NetBanking/bKash)
                          </span>
                        </div>
                      </div>
                    </RadioGroup>
                ...
                <div className="flex flex-col py-3 gap-2">
                  ...
                  <p className="text-xs">
                    <span className="font-bold">Delivery Time:</span> Inside
                    Dhaka - 5 days & Outside Dhaka - 10 days.
                  </p>
                  <div className="flex items-center gap-2">
                    <FormField
                      control={form.control}
                    ...
                    <span className="text-xs">
                      ...
                      <span className="underline text-red-500">
                        terms and conditions, return and refund policy
                      </span>{" "}
                      &{" "}
                      <span className="underline text-red-500">
                        privacy policy *
                ...
                <Button
                  className="w-full mt-3 bg-[#f97316] hover:bg-[#f97316]"
                  size={"lg"}
                  variant={"destructive"}
                  disabled={
                    isLoading || loading || cart?.cartItems?.length === 0
                  }
                >
                  {(isLoading || loading) && (
                    <IconLoader className="animate-spin" size={17} />
                  )}
                  <span className="px-2">Place Order</span>
                </Button>
              </div>
            </div>
          </form>
