...
const FashionQueensWhereFashionTalks = () => {
        ...
        <section className="bg-[#F6F6F6]">
            <div className=" py-5 md:container mx-auto px-2 md:px-4 lg:px-[2rem]">
                <h2 className="text-xl md:text-2xl font-semibold text-start mb-4">
                    Fashion Queens - Where Fashion Talks
                </h2>
                <Carousel
                    opts={{
                        align: "start",
                ...
                >
                    ...
                    <CarouselPrevious className="left-3 lg:flex hidden" />
                    <CarouselNext className="right-3 lg:flex hidden" />
                </Carousel>
            </div>
        </section>
    );
...
export default FashionQueensWhereFashionTalks;
