...
export default function Sidebar2({
  ...
  const links = sideLinks(role);

  const { data, isLoading } = useAdminProfileQuery({});

  // console.log(data?.data, "admin profile");
  ...
  return (
    ...
    >
      ...
      <Layout>
        {/* Header */}
        <LayoutHeader className="sticky top-0 justify-between px-4 py-3  md:px-4 border-0">
          <div className={`flex items-center ${!isCollapsed ? "gap-2" : ""}`}>
            ...
            >
              ...
              <line
                ...
                strokeWidth="16"
              ></line>
              <span className="sr-only">youngheartbd</span>
            </svg>
