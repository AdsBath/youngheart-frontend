...
// Defer loading of heavy dashboard sub-sections until needed
...
const Analytics = dynamic(() => import("@/components/dashboard/analytics"), {
     ...
     ssr: false, // often analytics has client-only libs (charts) -> skip SSR
});
...
// Track which tabs have been visited so we only mount each once (preserve state)
