...
export default function ProductsForm({ productData }: ProductsFormProps) {
    ...
    const {
        ...
        isLoading: productCollectionsLoading,
                    ...
                    toast({
                        ...
                        description: (
                            <pre className="mt-2 w-[340px] rounded-md bg-slate-950 p-4">
                                <code className="text-white">
                                    Product Name :
                                    {JSON.stringify(result.data.name, null, 2)}
                                </code>
                            </pre>
                        ),
                    });
                            ...
                            <div className="grid auto-rows-max items-start gap-4 lg:col-span-2 lg:gap-8">
                                ...
                                <Card>
                                    <CardHeader>
                                        ...
                                        <CardDescription>
                                            pricing information about the
                                            product. You can add multiple
                                ...
                                <Card>
                                    <CardHeader>
                                        ...
                                        <CardDescription>
                                            Category ,Bundle Discount and
                                            Product Collection information about
                                            the product. You can add multiple
                                            variants of the product here.
                                        </CardDescription>
                                    </CardHeader>
                                    <CardContent>
                          ...
                          /> */}
                                ...
                                <Card>
                                    <CardHeader>
                                        ...
                                        <CardDescription>
                                            Select the variants of the product.
                                            You can add multiple variants of the
                                            product here.
                                        </CardDescription>
                                    </CardHeader>
                                    <CardContent>
                                ...
                                <Card>
                                    <CardHeader>
                                        ...
                                        <CardDescription>
                                            Your must be add seo information for
                                            make a google search able got
                                            product
                                        </CardDescription>
                                    </CardHeader>
                                    <CardContent>
                ...
                Single Product Image  */}
                                ...
                                >
                                    <CardHeader>
                                        ...
                                        <CardDescription>
                                            Single product image and information
                                            about the product.
                                        </CardDescription>
                                    </CardHeader>
                                    <CardContent>
